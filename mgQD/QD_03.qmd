...
&#x1F4AA; [https://tweedback.de/eykf](https://tweedback.de/eykf)
...
- Gütekriterien der Forschung
  - Ethische Aspekte
  - Objektivität
  - Transparanz und Reproduzierbarkeit
  - interne und externe Validität
  
- Weiter mit R und RStudio gearbeitet
...
Diskutieren Sie in Ihrer Gruppe das genannte Gütekriterium. Was kann ich tun, damit das [Messergebnis]{.gray} gut mit dem [Wert der Eigenschaft]{.blue} übereinstimmt?

&#x1F4AA; [https://bit.ly/3Sms4wC](https://bit.ly/3Sms4wC)
...
Datei `EineLuege_Fortsetzung.Rmd` im Ordner `fallstudien` öffnen.
